...
query_doctors and query_services are discovered dynamically from the MCP server
...
mcp_tools      = asyncio.run(_mcp_client.get_tools())   # [query_doctors, query_services]
