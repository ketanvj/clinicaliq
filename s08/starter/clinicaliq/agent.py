...
Session 8: tools.py now uses MultiServerMCPClient to discover query_doctors and
query_services from the Session 7 MCP server. Graph structure is unchanged
from Session 5.

Run with:
    python -m clinicaliq.agent   (from inside s08/solution/)
"""
import os
import sqlite3
