...
Goal
  Connect the ClinicalIQ agent to the MCP server built in Session 7
  ...
  from Session 5 -- only how query_doctors/query_services are sourced changes.
...
Run when done
  python -m clinicaliq.agent   (from inside s08/starter/)
"""
import asyncio
import sys
