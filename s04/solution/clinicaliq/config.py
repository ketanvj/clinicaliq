...
IN_SCOPE     : Any question about Apollo Health Clinic services — departments, appointments,
               clinic timings, diagnostic tests, test preparation, registration, or general procedures.
...
OUT_OF_SCOPE : Anything unrelated to Apollo Health Clinic services, or clinical/medical questions
               requiring a doctor's judgement (symptoms, diagnosis, medication, treatment advice).
               Examples: "I have chest pain — what should I do?", "What medicine should I take?",
